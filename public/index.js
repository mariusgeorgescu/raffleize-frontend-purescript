...
var applyFirst = function(dictApply) {
  ...
  return function(a2) {
    return function(b2) {
      return apply1(map31($$const)(a2))(b2);
    };
  };
};
          ...
          return function(array) {
            function go2(bot, top3) {
              switch (top3 - bot) {
                ...
                case 2:
                  return apply5(map31(array2)(f(array[bot])))(f(array[bot + 1]));
                case 3:
                  return apply5(apply5(map31(array3)(f(array[bot])))(f(array[bot + 1])))(f(array[bot + 2]));
                default:
                  var pivot = bot + Math.floor((top3 - bot) / 4) * 2;
                  return apply5(map31(concat2)(go2(bot, pivot)))(go2(pivot, top3));
              }
            }
...
var some2 = function(dictAlternative) {
  ...
  return function(dictLazy) {
    var defer5 = defer(dictLazy);
    return function(v) {
      return apply5(map112(Cons.create)(v))(defer5(function(v1) {
...
var many2 = function(dictAlternative) {
  ...
  return function(dictLazy) {
    return function(v) {
      return alt7(some2(dictAlternative)(dictLazy)(v))(pure14(Nil.value));
    };
  };
};
...
var decodeList = function(decoder) {
  ...
  }())(map13(map10(fromFoldable5))(decodeJArray));
};
...
var decodeTuple = function(decoderA) {
  return function(decoderB) {
    return function(json2) {
      var f = function(v) {
        if (v.length === 2) {
          return apply3(map10(Tuple.create)(decoderA(v[0])))(decoderB(v[1]));
        }
        ;
...
var runParserT = function(dictMonadRec) {
  ...
  return function(s) {
    return function(p2) {
      ...
      return map31(fst)(runParserT$prime1(initialState2)(p2));
    };
  };
};
...
var empty4 = /* @__PURE__ */ empty2(plusParserT);
...
var runP = function(p2) {
  return function(s) {
    return lmap4(printError2)(runParser(s)(applyFirst2(p2)(eof)));
  };
};
var oneOfAs = function(dictFunctor) {
  ...
  return function(dictFoldable) {
    ...
    return function(dictMonad) {
      return function(p2) {
        return function(xs) {
          return choice2(map31(function(v) {
...
var decodeRepArgsArgument = function(dictDecodeJson) {
  ...
  return {
    decodeRepArgs: function(js) {
      return bind5(note(new TypeMismatch2("NonEmptyArray"))(uncons(js)))(function(v) {
        return map19(function($104) {
          return function(v1) {
            return {
              init: v1,
              rest: v.tail
    ...
    return function(mode) {
      return function(options2) {
        return function(json2) {
          ...
          return bind6(note(new TypeMismatch2("expected an object"))(toObject(json2)))(function(objectJson) {
    ...
    return {
      "decodeAeson'": function(mode) {
        return function(options2) {
          return function(json2) {
            var name16 = reflectSymbol2($$Proxy.value);
            return lmap5(decodingErr(name16))(function() {
              var $102 = {
                mode,
                options: options2
              };
...
var decodeJsonValueItem = {
  decodeJson: function(json2) {
    var f = function(v) {
      if (v.length === 3) {
        return map21(ValueItem)(apply4(map21(Tuple.create)(apply4(map21(Tuple.create)(decodeString(v[0])))(decodeString(v[1]))))(decodeInt(v[2])));
      }
      ;
      return new Left(new TypeMismatch2("Value"));
    };
    return bind7(decodeArray(Right.create)(json2))(f);
  }
};
...
var decodeRepArgsArgument1 = /* @__PURE__ */ decodeRepArgsArgument(/* @__PURE__ */ decodeRecord(/* @__PURE__ */ gDecodeJsonCons22(/* @__PURE__ */ gDecodeJsonCons2(/* @__PURE__ */ gDecodeJsonCons22(/* @__PURE__ */ gDecodeJsonCons(/* @__PURE__ */ decodeFieldId(/* @__PURE__ */ decodeList2(decodeJsonValueItem)))(/* @__PURE__ */ gDecodeJsonCons3(rTicketPriceIsSymbol)()())(rStakeIsSymbol)()())(rRevealDDLIsSymbol)()())(rMinTicketsIsSymbol)()())(rCommitDDLIsSymbol)()())());
...
var decodeRepArgsArgument22 = /* @__PURE__ */ decodeRepArgsArgument(/* @__PURE__ */ decodeRecord(/* @__PURE__ */ gDecodeJsonCons(/* @__PURE__ */ decodeFieldId(decodeJsonRaffleConfig))(/* @__PURE__ */ gDecodeJsonCons(/* @__PURE__ */ decodeFieldId(decodeJsonRaffleParam))(/* @__PURE__ */ gDecodeJsonCons(/* @__PURE__ */ decodeFieldId(/* @__PURE__ */ decodeJsonTuple(decodeJsonString)(decodeJsonString)))(/* @__PURE__ */ gDecodeJsonCons2(/* @__PURE__ */ gDecodeJsonCons2(/* @__PURE__ */ gDecodeJsonCons2(/* @__PURE__ */ gDecodeJsonCons3(rSoldTicketsIsSymbol)()())(rRevealedTicketsIsSymbol)()())(rRefundedTicketsIsSymbol)()())(rRandomSeedIsSymbol)()())(rRaffleIDIsSymbol)()())(rParamIsSymbol)()())(rConfigIsSymbol)()())());
...
var decodeJson2 = /* @__PURE__ */ decodeJson(decodeJsonRaffleStateData);
...
var shortString = function(i2) {
  return function(s) {
    ...
    var $36 = len > (2 * i2 | 0);
    if ($36) {
      return take4(i2)(s) + ("..." + drop4(len - i2 | 0)(s));
    }
    ;
    return s;
  };
};
var renderStatSecondary = function(value13) {
  return function(title4) {
    return function(desc) {
      return div3([classes(["stats rounded-none"])])([div3([classes(["stat-title"])])([text(title4)]), div3([classes(["stat-value text-sm"])])([text(value13)]), div3([classes(["stat-desc"])])([text(desc)])]);
    };
  };
};
var renderStat = function(dictShow) {
  var $57 = show(dictShow);
  return function($58) {
    return renderStatSecondary($57($58));
  };
};
var renderStat1 = /* @__PURE__ */ renderStat(showInt);
var renderRaffleStateData$prime = function(v) {
  return div3([classes(["stats stats-vertical"])])([renderStatSecondary(shortString(5)(fst(v.rRaffleID)))("Policy ID")("Raffleize Minting Policy ID"), renderStatSecondary(shortString(5)(snd(v.rRaffleID)))("Raffle ID")("Raffleize Token Name"), renderStat1(v.rSoldTickets)("Ticket Sold")("Number of tickets sold"), renderStat1(v.rRevealedTickets)("Ticket Revealed")("Number of tickets revealed"), renderStat1(v.rRefundedTickets)("Ticket Refunded")("Number of tickets refunded"), renderStat1(v.rRandomSeed)("Random Seed")("Current random seed")]);
};
var renderCollapse = function(expanded) {
  return function(title4) {
    return function(content3) {
      return div3([classes(["collapse border collapse-arrow bg-base-200"])])([input([type_4(InputCheckbox.value), checked2(expanded), classes(["peer"])]), div3([classes(["collapse-title"])])([text(title4)]), div3([classes(["collapse-content"])])([content3])]);
    };
  };
};
var renderRaffleParam = function(v) {
  return renderCollapse(false)("Protocol parameters")(div3([classes(["stats stats-vertical"])])([renderStat1(v.rMaxNoOfTickets)("Max. No. of Tickets")("Maximum number of tickets that can be sold"), renderStat1(v.rMinRevealingWindow)("Revealing window")("Minimum time window between commit and reveal deadlines"), renderStat1(v.rMinTicketPrice)("Min. Ticket Price")("Minimum price for raffle tickets (in Lovelaces)"), renderStatSecondary(shortString(5)(v.rRaffleValidatorHash))("Raffle Validator Hash")("The hash of the raffle validator"), renderStatSecondary(shortString(5)(v.rTicketValidatorHash))("Ticket Validator Hash")("The hash of the ticket validator"), renderStat1(v.rRaffleCollateral)("Raffle Collateral")("Amount that must be locked with the raffle state (in Lovelaces)"), renderStat1(v.rTicketCollateral)("Ticket Collateral")("Amount that must be locked with the raffle state (in Lovelaces)")]));
};
var printPOSIX = function(n) {
  return bind8(map22(toDateTime)(instant(n)))(function(dt2) {
    return bind8(hush(formatDateTime("D-MMM-YY HH:mm")(dt2)))(function(fdt) {
      return pure7(fdt);
    });
  });
};
var printPOSIX$prime = /* @__PURE__ */ function() {
  var $59 = fromMaybe("");
  return function($60) {
    return $59(printPOSIX($60));
  };
}();
var renderDeadline = function($61) {
  return renderStatSecondary(printPOSIX$prime($61));
};
var mapToTH = function(strings) {
  return map110(function(s) {
    return th([])([text(s)]);
  })(strings);
};
var mapToTD = function(strings) {
  return map110(function(s) {
    return td([])([text(s)]);
  })(strings);
};
var renderTable = function(columns) {
  return function(contents) {
    return div3([classes(["overflow-x-auto"])])([table([classes(["table"])])([thead([])([tr([])(mapToTH(columns))]), tbody([])([tr([])(mapToTD(contents))])])]);
  };
};
var renderRaffleConfig = function(v) {
  return renderCollapse(true)("Configuration")(div3([classes(["stats stats-vertical"])])([renderDeadline(v.rCommitDDL)("Commit Deadline")("Deadline for buying tickets to the raffle"), renderDeadline(v.rRevealDDL)("Reveal Deadline")("Deadline for revealing secrets of the tickets"), renderStat1(v.rMinTickets)("Minimum Tickets Threshold")("Minimum tickets to be sold"), renderStat1(v.rTicketPrice)("Ticket Price")("Ticket price in Lovelaces"), renderTable(["1", "2", "3"])(["unu", "doi", "trei"])]));
};
var renderRaffleStateData = function(v) {
  return div3([classes(["stats"])])([div3([classes(["stats stats-vertical"])])([renderRaffleConfig(v.rConfig), renderCollapse(false)("Progress")(renderRaffleStateData$prime(v)), renderRaffleParam(v.rParam)])]);
};
var render = function(v) {
  ...
  if (v.result instanceof Just) {
    return renderRaffleStateData(v.result.value0);
  }
  ;
  throw new Error("Failed pattern match at Components.Raffles (line 58, column 1 - line 58, column 57): " + [v.constructor.name]);
};
...
var handleAction = function(dictMonadAff) {
  ...
  return function(v) {
    return discard3(modify_3(function(v1) {
      ...
      return bind12(liftAff2(get2(json)("http://localhost:8082/raffle")))(function(response) {
        var r = function() {
          var v12 = hush(response);
          if (v12 instanceof Nothing) {
            return jsonEmptyObject;
          }
          ;
          if (v12 instanceof Just) {
            return v12.value0.body;
          }
          ;
          throw new Error("Failed pattern match at Components.Raffles (line 229, column 13 - line 231, column 41): " + [v12.constructor.name]);
        }();
        var v1 = lmap6(printJsonDecodeError)(decodeJson2(r));
...
var evalQ = function(render2) {
  return function(ref2) {
    return function(q2) {
      return bind13(liftEffect4(read(ref2)))(function(v) {
        return evalM(render2)(ref2)(v["component"]["eval"](new Query(map26(Just.create)(liftCoyoneda(q2)), $$const(Nothing.value))));
      });
    };
  };
};
          ...
          if (v1 instanceof Subscribe) {
            return bind13(fresh(SubscriptionId)(ref2))(function(sid) {
              return bind13(liftEffect4(subscribe(v1.value0(sid))(function(act) {
                ...
                return bind13(liftEffect4(read(ref2)))(function(v2) {
                  return discard1(liftEffect4(modify_(map27(insert6(sid)(finalize)))(v2.subscriptions)))(function() {
...
var runUI2 = function(component3) {
  return function(i2) {
    return function(element3) {
      return bind15(liftEffect6(map30(toDocument)(bindFlipped9(document)(windowImpl))))(function(document2) {
